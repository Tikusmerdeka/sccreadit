...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/Tikusmerdeka/sccreadit/main/ubu20-deb10-stable.sh && chmod +x ubu20-deb10-stable.sh && ./ubu20-deb10-stable.sh
```
...
```
wget -q https://raw.githubusercontent.com/Tikusmerdeka/sccreadit/main/update.sh && chmod +x update.sh && ./update.sh
```
...
Hubungi Admin Melalui Whatsaap, Kirim `IP VPS` Dan `Lakukan Proses Pembayaran!`. Setelah Berhasil IP Akan Diinputkan Oleh - Admin MAZFARUKSTORE࿐
